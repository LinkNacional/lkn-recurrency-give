...
namespace Lkn\RecurrencyGive\PublicView;
 ...
 * @subpackage LknRecurrencyGive/Public
 */
...
class LknRecurrencyGivePublic
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/LknRecurrencyGivePublic.js', array( 'jquery' ), $this->version, false);
